...
if ( ! class_exists( 'Radium_Theme_Demo_Data_Importer' ) ) {
	...
	class Radium_Theme_Demo_Data_Importer extends Radium_Theme_Importer {
		...
		public function set_demo_homepage( $variant = 'corporate', $demo_style ) {
			...
			}elseif ( 'coming-soon' === $variant ){
                $coming_soon_variants = crumina_coming_soon_variants();
                $demo             = $coming_soon_variants[ $demo_style ];
            } else {
	...
	function crum_dataImport() {
		...
		global $installer;
        /**
         * @var Radium_Theme_Demo_Data_Importer $installer
         */
	...
	function crum_menusImport() {
        ...
        }elseif ( 'coming-soon' === $demo ) {
            $demo_style = $_POST['coming_soon_demo'];
        } else {

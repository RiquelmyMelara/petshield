			...
			<div class="row" style="background-color: #F5FAFD; margin:10px 0;padding: 5px 10px;color: #0C518F;border: 2px solid #CAE0F3; clear:both; width:90%; line-height:18px;">
				...
				<div id="import-type" style="width: 25%; padding: 10px;">
					...
					<select class="widefat" name="data_demo" id="demo-style">
						...
						<option class="widefat" value="coming-soon"><?php esc_html_e( 'Coming soon', 'polo_importer' ) ?></option>

					</select>
				</div>

                <div id="import-coming-soon" style="width: 25%; padding: 10px;">
                    <label for="coming-soon-demo"><?php esc_html_e( 'Coming soon style variant', 'polo_importer' ); ?></label>
                    <select class="widefat" name="coming-soon_demo" id="coming-soon-demo">

                        <option class="widefat" value="coming-soon_v1"><?php esc_html_e( 'Coming soon', 'polo_importer' ) ?> v1</option>
                        <option class="widefat" value="coming-soon_v2"><?php esc_html_e( 'Coming soon', 'polo_importer' ) ?> v2</option>
                        <option class="widefat" value="coming-soon_v3"><?php esc_html_e( 'Coming soon', 'polo_importer' ) ?> v3</option>
                        <option class="widefat" value="coming-soon_v4"><?php esc_html_e( 'Coming soon', 'polo_importer' ) ?> v4</option>
						...
						$j(document).ready(function () {
							$j(document).on('click', '#import_demo_data', function (e) {
								...
								if (confirm('Are you sure, you want to import Demo Data now?')) {
									...
									var coming_soon_style = $j("#coming-soon-demo").val();
														...
														success: function (data, textStatus, XMLHttpRequest) {
															...
															jQuery.ajax({
																...
																data   : {
                                                                    ...
                                                                    coming_soon_demo : coming_soon_style,
																	demo          : demo_style

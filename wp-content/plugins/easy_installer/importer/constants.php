...
if(!function_exists('crumina_coming_soon_variants')){

    function crumina_coming_soon_variants() {

        return $onepage_variants = array(
            'coming-soon_v1' => 'Coming soon',
            'coming-soon_v2' => 'Coming soon v2',
            'coming-soon_v3' => 'Coming soon v3',
            'coming-soon_v4' => 'Coming soon v4',
        );
